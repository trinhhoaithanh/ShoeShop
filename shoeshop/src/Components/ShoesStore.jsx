...
export default class ShoesStore extends Component {
  ...
  constructor(props){
    ...
    this.state={
      ...
      // tạo nguồn dữ liệu thay đổi khi người nhấn nút
    }
  }
  //Viết hàm này tại nơi chứ nguồn dữ liệu thay đổi
  ...
  render() {
    return (
      <>
      <ProductList products={this.productData} setStateModal={this.setStateModal}/>
